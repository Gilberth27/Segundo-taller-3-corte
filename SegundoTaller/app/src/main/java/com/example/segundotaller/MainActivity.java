...
public class MainActivity extends AppCompatActivity {
    ...
    public void  registrar (View view){
        ...
        EditText editText2 = (EditText) findViewById(R.id.txttelefono);
        ...
        String url = "https://bedraggled-freezes.000webhostapp.com/TercerCorte/registrar.php?nombre="+message+"&apellido="+message1+"&telefono="+message2;
